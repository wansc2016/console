...
export const CreateYAML = connectToPlural((props: CreateYAMLProps) => {
  ...
  // t('demo~Group')
  // t('demo~Role')
  // t('demo~Service Account')
  // t('demo~Service')
  // t('demo~Pod')
  // t('demo~Container')
  // t('demo~Deployment')
  // t('demo~Deployment Config')
  // t('demo~Build Config')
  // t('demo~Template')
  // t('demo~Template Instance')
  // t('demo~Image Stream')
  // t('demo~Node')
  // t('demo~Event')
  // t('demo~Namespace')
  ...
  // t('demo~Cluster Role')
  // t('demo~Role Binding')
  // t('demo~Resource Access Review')
  // t('demo~Persistent Volume')
  // t('demo~Persistent Volume Claim')
  // t('demo~Petset')
  // t('demo~Stateful Set')
  // t('demo~Network Policy')
  // t('demo~Service Instance')
  // t('demo~Service Binding')
  // t('demo~API Service')
  // t('demo~User')
  const header = t('demo~Create {{label}}', { label });
